...
This page describes how to contribute to [MyPkg36.jl](https://github.com/ohno/MyPkg36.jl).

## Contributing

The [ColPrac](https://github.com/SciML/ColPrac) guidelines is recommended. Please open an [issue](https://github.com/ohno/MyPkg36.jl/issues) before starting significant work.

## Versioning

This project follows [Semantic Versioning](https://semver.org/). When bumping the version, update the version number in:
- [Project.toml](https://github.com/ohno/MyPkg36.jl/blob/main/Project.toml#L4)
- [CITATION.bib](https://github.com/ohno/MyPkg36.jl/blob/main/CITATION.bib#5)
...
```sh
git clone https://github.com/ohno/MyPkg36.jl.git
cd MyPkg36.jl
```
...
```sh
julia --startup-file=no -i -E 'using Revise; import Pkg; Pkg.activate(\".\"); using MyPkg36; MyPkg36.hello()'
```

### Add Dependency

Use these commands to add `PkgName.jl` as a dependency. `Pkg.add` updates [Project.toml](https://github.com/ohno/MyPkg36.jl/blob/main/Project.toml). If dependencies were edited manually, run `Pkg.resolve()` and `Pkg.instantiate()`.
